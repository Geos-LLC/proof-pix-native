...
// Share module (react-native-share) - conditional load
let RNShare = {
  open: async () => {
    console.log('[Share] react-native-share not available. Share.open call ignored.');
  },
};
  ...
  const startSharingWithOptions = async () => {
    ...
    try {
      ...
      if (shareAsArchive) {
        ...
        await RNShare.open({ urls, type: 'image/jpeg' });
      }
    } catch (error) {
